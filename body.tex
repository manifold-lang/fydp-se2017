...
Unlike a system of SMT2 equations, a simulation of a Modelica model is more expressive in simulating how the model will behave with time. 
This allows for analysis for verification, with respect to the design requirement for parameters that may vary temporally.
